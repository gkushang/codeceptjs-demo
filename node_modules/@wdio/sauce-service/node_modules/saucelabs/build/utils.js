...
exports.getAssetHost = getAssetHost;
...
function getAssetHost(options) {
  ...
  const region = _constants.ASSET_REGION_MAPPING[options.region] || '';
...
function createProxyAgent(proxy) {
  ...
  if (proxyURL.protocol === 'https:') {
    return {
      https: _tunnel.default.httpsOverHttps({
        proxy: {
    ...
    return {
      https: _tunnel.default.httpsOverHttp({
        proxy: {
          host: proxyURL.hostname,
          port: proxyURL.port
        }
