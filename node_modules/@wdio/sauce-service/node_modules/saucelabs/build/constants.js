...
const DEFAULT_SAUCE_CONNECT_VERSION = '4.6.5';
...
const SAUCE_CONNECT_DISTS = [[`${SAUCE_CONNECT_BASE}/sc-%s-osx.zip`, 'darwin'], [`${SAUCE_CONNECT_BASE}/sc-%s-win32.zip`, 'win32'], [`${SAUCE_CONNECT_BASE}/sc-%s-linux.tar.gz`, 'linux']];
